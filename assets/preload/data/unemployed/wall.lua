...
idleoffsets = {'-3', '5'} -- I recommend you have your idle offset at 0
leftoffsets = {'10', '-16'}
downoffsets = {'-30', '-27'}
upoffsets = {'-47', '56'}
rightoffsets = {'-28', '15'}
...
left_xml_name = 'Void Left Note Hype'
down_xml_name = 'Void Down Note Hype'
up_xml_name = 'Void Up Note Hype'
right_xml_name = 'Void Right Note Hype'
